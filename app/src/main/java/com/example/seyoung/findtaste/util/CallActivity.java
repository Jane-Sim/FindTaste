...
import com.example.seyoung.findtaste.util.AppRTCAudioManager.AudioDevice;
import com.example.seyoung.findtaste.util.AppRTCAudioManager.AudioManagerEvents;
import com.example.seyoung.findtaste.util.AppRTCClient.RoomConnectionParameters;
import com.example.seyoung.findtaste.util.AppRTCClient.SignalingParameters;
import com.example.seyoung.findtaste.util.PeerConnectionClient.DataChannelParameters;
import com.example.seyoung.findtaste.util.PeerConnectionClient.PeerConnectionParameters;
 ...
 * and call view.
 * 영상통화를 할 수 있는 프래그먼트입니다.
 * 나와 상대방의 얼굴이 한 화면에 나타나며, 영상통화를 종료시킬 수 있습니다.
 */
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  public static String FRIENDNAME = "org.appspot.apprtc.ID";
  //상대방의 이름을 받아올 스트링입니다.
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // 연결 클라이언트를 만듭니다. 방 이름이 IP 인 경우 DirectRTCClient를 사용하고 그렇지 않으면 표준 WebSocketRTCClient를 사용하십시오.
